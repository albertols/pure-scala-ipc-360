...
/**
 * Sanitized runtime config for the frontend: GCP project id/region, URL templates
 ...
 */
public record AppConfigDto(String projectId, String region, String dataprocJobUrl,
