...
export function TimePicker({
  ...
  const setNow = () =>
    onChange({ date: todayStr(), hour: currentHour(), precision: 'hour', isNow: true })
  ...
  return (
    ...
    >
      ...
      >
        Time View{' '}
        <InfoTooltip
          text="Navigate to a historical snapshot of the operational state. 'Now' shows the current live state."
          placement="bottom"
        />
      </span>
