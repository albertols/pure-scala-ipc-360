...
const EMPTY_GRAPH: CanvasGraph = { nodes: [], connections: [], mappingNames: [], renderedMapping: '' }
    ...
    >
      <div style={{
        ...
        <div style={{
          ...
          <span style={{
            fontSize: 12, fontWeight: 700, color: '#e2e8f8', flex: 1,
            fontFamily: 'JetBrains Mono, monospace',
          }}>{title}</span>
          <button onClick={onClose} title="Close"
            style={{ background: 'none', border: 'none', color: '#4a5570', cursor: 'pointer', padding: 4 }}>
        ...
        {showXmlFallback && (
          <div style={{ padding: '6px 16px', fontSize: 11, color: 'var(--text-dim)', flexShrink: 0 }}>
